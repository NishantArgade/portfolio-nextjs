...
const Skills = ({ heading }: { heading: string }) => {
  ...
  return (
    <>
      <div
        id="skills"
        className="bg-background1 min-h-[30rem] w-screen pt-[80px]"
      >
        <div className="absolute">
          <svg
            ...
            className="-top-30  -left-30 relative z-0 w-[15rem]"
          >
            <path
        ...
        <div className="absolute">
          <svg
            ...
            viewBox="0 0 480 480"
            xmlns="http://www.w3.org/2000/svg"
            className="relative -right-[65rem] top-[10rem] -z-0 w-[30rem]"
          >
            <path
              fill="rgba(148, 234, 255, 0.1)"
