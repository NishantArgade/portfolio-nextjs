      ...
      >
        <div className="absolute">
          <svg
            ...
            className="relative -right-[10rem] top-[10rem] z-0 w-[14rem] "
          >
            <path
        ...
        <div className="absolute">
          <svg
            ...
            viewBox="0 0 480 480"
            xmlns="http://www.w3.org/2000/svg"
            className="relative -top-[5rem] right-[15rem] z-0 w-[25rem]"
          >
            <path
              fill="rgba(148, 234, 255, 0.1)"
              d="M390.5,342.5Q359,445,248.5,430.5Q138,416,78.5,328Q19,240,83.5,160.5Q148,81,249.5,64.5Q351,48,386.5,144Q422,240,390.5,342.5Z"
        ...
        <div className="absolute">
          <svg
            viewBox="0 0 200 200"
            className="relative -right-[61rem] top-[20rem] z-0 w-[22rem]"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              fill="rgba(148, 234, 255, 0.1)"
